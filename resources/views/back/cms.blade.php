                                                        ...
                                                        <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                                                            <li class="nav-item" role="presentation">
                                                                <a class="nav-link active fw-semibold" data-bs-toggle="tab" href="#productnav-all" role="tab" aria-selected="true">
                                                                    All <span class="badge badge-soft-danger align-middle rounded-pill ms-1">{{count($cms)}}</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                                                ...
                                                                                @foreach($cms as $content)
                                                                                    ...
                                                                                    <tr class="gridjs-tr">
                                                                                            ...
                                                                                            <span>
                                                                                                <div class="d-flex align-items-center">
                                                                                                    ...
                                                                                                    <div class="flex-grow-1">
                                                                                                        <h5 class="fs-14 mb-1">
                                                                                                            <a href="" class="text-dark"> {{$content->name}}</a>
                                                                                                        </h5>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </span>
                                                                                        ...
                                                                                        <td data-column-id="product" class="gridjs-td">
                                                                                            <span>@php echo $content->content; @endphp</span>
                                                                                        </td>
                                                                                            ...
                                                                                            <span>
                                                                                                <div class="dropdown">
                                                                                                    ...
                                                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                                                        <li>
                                                                                                            <a class="dropdown-item edit-list"  href="{{url('/addcms', Illuminate\Support\Facades\Crypt::encrypt($content->id))}}">
