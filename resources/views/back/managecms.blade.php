                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{url('/cms')}}">Content Management</a></li>
                                                ...
                                                <div class="mb-5 mt-3">
                                                    <div class="live-preview">
                                                        <div class="table-responsive">
                                                            <form action="{{url('addcms')}}" method="POST"  enctype="multipart/form-data">
                                                                @csrf
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12 col-xs-12">
                                                                            <div class="mb-4">
                                                                                ...
                                                                                <input type="text" class="form-control" name="name" @if(isset($content)) value="{{$content->name}}" @endif required="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12 col-xs-12">
                                                                            <div class="mb-4">
                                                                                ...
                                                                                @if(isset($content) && ($content->id == 7 OR $content->id == 8 OR $content->id == 9 OR $content->id == 10 OR $content->id == 11))
                                                                                    <input type="text" class="form-control" name="content" @if(isset($content)) value="{{$content->content}}" @endif required="">
                                                                                @else
